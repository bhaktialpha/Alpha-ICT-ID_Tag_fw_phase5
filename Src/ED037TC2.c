...
if(flags.Image_USB_Received_Flag == 1)
		  img_kw=img_kw+3;
	else
		  img_kw=img_kw+0;
...
void EPD_Display_KW1(const unsigned char *img_kw, unsigned int size)
{
...
void EPD_Display_KW1_Dummy(const unsigned char *img_kw, unsigned int size)
{
